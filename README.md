...
Update the Test Script: In the test script (e.g., studydrive-onboarding.spec.js), update the email_address and password fields with valid credentials for registration:
...
Email Verification: After completing the registration, an email will be sent to the provided address. Follow the instructions in the email to verify the account before proceeding with further actions like course joining or document upload.
